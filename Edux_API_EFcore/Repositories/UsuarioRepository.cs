...
namespace Edux_Api_EFcore.Repositories
{
    public class UsuarioRepository : IUsuarioRepository
    {
        ...
        public Usuario BuscarPorId(Guid id)
        {
            try
            {
                return _ctx.Usuarios.Include(u => u.AlunosTurmas).ThenInclude(a => a.ObjetivosAlunos).ThenInclude(o=>o.Objetivo).Include(t=>t.ProfessoresTurmas).FirstOrDefault(u=>u.Id==id);
            }
            catch (Exception ex)
            {
